...
<div class="uap-stuffbox">
	...
	<div class="inside">
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-6">
					<h3><?php esc_html_e('Which Amount should be used for Referral calculation?', 'uap');?></h3>
		...
		<div class="uap-inside-item">
			<div class="row">
				<div class="col-xs-4">
				<h3><?php esc_html_e('Affiliate Link Settings', 'uap');?></h3>
				<br/>
			...
			<div class="row">
				<div class="col-xs-4">
				<h3><?php esc_html_e('Base Affiliate Link', 'uap');?></h3>
				<br/>
					<div class="form-group">
...
Do not enter a link from a different website.', 'uap');?></p>
	...
	<div class="uap-inside-item">
		<div class="row">
			<div class="col-xs-4">
			<h3><?php esc_html_e('Affiliate Link URL Blacklist', 'uap');?></h3>
			<br/>
