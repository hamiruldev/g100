...
/* harmony default export */ __webpack_exports__["default"] = (function (sectionId) {
  return _objectSpread(_objectSpread({}, _affiliatewp_portal_alpine_form__WEBPACK_IMPORTED_MODULE_3___default.a), {
    ...
    setupSubmit: function setupSubmit() {
      return _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()({}, 'x-bind:disabled', function xBindDisabled() {
    ...
    setupField: function setupField(id) {
      ...
      var additionalDirectives = (_additionalDirectives = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(_additionalDirectives, 'x-on:input', function xOnInput(event) {
        var _this2 = this;
      ...
      }), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(_additionalDirectives, 'x-on:blur', function xOnBlur() {
        this.validateControl(id);
    ...
    setupForm: function setupForm() {
      return _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()({}, 'x-on:submit', function xOnSubmit(event) {
        var _this5 = this;
...
/*!*********************************************************!*\
  !*** external {"this":["AFFWP","portal","alpineForm"]} ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

(function() { module.exports = this["AFFWP"]["portal"]["alpineForm"]; }());
