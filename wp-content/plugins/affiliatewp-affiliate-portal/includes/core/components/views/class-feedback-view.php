...
class Feedback_View implements View {
	...
	public function get_controls() {
		...
		$controls[] = new Controls\Paragraph_Control( array(
			...
			'section' => 'feedback',
			'args'    => array(
				'text' => __( 'Sandhills Development (the software company who created this affiliate portal) would love to hear about your experience using this affiliate portal. No personal data will be collected and any feedback provided will only be used to help improve your experience.', 'affiliatewp-affiliate-portal' ),
			),
		) );
		...
		$controls[] = new Controls\Link_Control( array(
			...
			'atts'    => array(
				'href'   => 'https://docs.google.com/forms/d/e/1FAIpQLSdWz1N69cuhW4879IgNC2AJG__mHB3VE6nag04ReOeZjuGXpw/viewform',
				'target' => '_blank',
				'class'  => array(
					'inline-flex',
					'items-center',
