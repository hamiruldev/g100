	...
	public function register_ui() {
		...
		if ( true === $allow_affiliate_slugs ) {
			$registry->register_section( 'custom-affiliate-slugs-settings', array(
				'label'        => __( 'Custom affiliate slug', 'affiliate-wp' ),
				'desc'         => __( 'A custom affiliate slug allows you to have a unique referral URL using your chosen slug.', 'affiliate-wp' ),
				'priority'     => 10,
				'view_id'      => 'settings',
				'wrapper'      => true,
				'form_alpine'  => array(
		...
		if ( true === $show_slug_enabled || true === $slug_exists ) {
			$registry->register_section( 'custom-affiliate-slugs', array(
				'label'    => __( 'Your custom slug', 'affiliate-wp' ),
				'desc'     => __( 'A custom affiliate slug allows you to have a unique referral URL using your chosen slug.', 'affiliate-wp' ),
				'priority' => 3,
				'wrapper'  => true,
				'view_id'  => 'urls',
