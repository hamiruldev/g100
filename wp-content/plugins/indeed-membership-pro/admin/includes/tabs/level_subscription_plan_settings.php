...
<form method="post">
	<div class="ihc-stuffbox">
		<h3 class="ihc-h3"><?php esc_html_e('Membership - Subscription Plan Display Details', 'ihc');?></h3>
		<div class="inside">

			<div class="iump-form-line">
				<h2><?php esc_html_e('Activate/Hold this feature', 'ihc');?></h2>
...
have membership A and B. Another example would be: a user cannot purchase membership B if they never purchased a membership before.
				...
				<p><strong><?php esc_html_e('Important: In order to manage a membership with this filter, the Show up in Subscription Plan setting must be turned on. To turn this on for a membership that has already been created, go here and edit the membership.', 'ihc');?></strong></p>
					...
					<div class="iump-form-line">
						...
						<?php foreach ($levels as $lid=>$larr):?>
							...
							<div class="ihc-list-access-posts-memberships">
								...
								<input type="checkbox" <?php echo $checked;?> onClick="ihcMakeInputhString(this, '<?php echo $lid;?>', '<?php echo '#level' . $id . 'cond';?>');" /> <span  class="<?php echo $spanclass;?>"><?php echo $larr['label'];?></span>
							</div>
						<?php endforeach;?>
